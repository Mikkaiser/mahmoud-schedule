...
- Light and dark themes follow the iPad setting; add to Home Screen for a full-screen app.
- If the venue Wi-Fi drops, the last fetched schedule is shown from cache with an "offline" banner.
...
public/                 app.js, views/{board,now,person,sheet}.js, lib/, styles.css
